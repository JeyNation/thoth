...
export interface ZoomInIconProps { size?: number; stroke?: string; strokeWidth?: number; className?: string; title?: string; }
const ZoomInIcon: React.FC<ZoomInIconProps> = ({ size=18, stroke='currentColor', strokeWidth=2, className='', title }) => (
